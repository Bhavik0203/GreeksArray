...
const Hero = () => {
  ...
  <div className="w-full flex flex-col md:flex-row justify-between items-start  mb-8 ml-[30px] mr-[30px] " >
  <div className="md:w-1/2 flex-shrink-0 flex-grow ml-[30px] mb-[60px] mt-[60px]  ">
  <h1
    id="welcome"
    className="text-4xl lg:text-2xl text-left font-bold text-gray-900 font-spaceGrotesk mb-3 text-justify"
  >
  ...
  <Link to="/Allblogs">
    <button className="bg-black text-white px-4 py-2 rounded-lg mt-5">
      Start Reading
    </button>
  </Link>
</div>
